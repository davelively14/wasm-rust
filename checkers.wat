(module
  ...
  ;; At the end of a turn, switch turn over to the other player
  ...
  ;; i32.and queries only the bits in the mask
  ...
  ;; Ensures travel is 1 or two squares
  ...
  (func $initBoard
    ...
    (call $setPiece (i32.const 1) (i32.const 6) (get_global $WHITE))
    (call $setPiece (i32.const 3) (i32.const 6) (get_global $WHITE))
    (call $setPiece (i32.const 5) (i32.const 6) (get_global $WHITE))
    (call $setPiece (i32.const 7) (i32.const 6) (get_global $WHITE))
